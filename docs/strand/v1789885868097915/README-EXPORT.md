# Strand `_ds/` export — compile `v1789885868097915`

Swap this folder in whole. It is Strand at the correction 21 compile, with rulings 978, 981 and 984.
...
- `STRAND-CORRECTION-18-EXTRACTION.md`, `-19-`, `-20-` and `-21-` — carried here as files (876). 18 has 19's note appended against its §8; 19 has 20's note appended against its §3.
