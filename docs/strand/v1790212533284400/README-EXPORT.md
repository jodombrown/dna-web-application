# Strand `_ds/` export — compile `v1790212533284400`

Swap this folder in whole. It is Strand at the correction 25 compile (663 and 1102 with 1103; session 31), on top of correction 24 (1055), correction 23 (1083) and correction 21 (ratified 987).
